...
import com.mraof.minestuck.client.gui.captchalouge.ArrayGuiHandler;
  ...
  protected int size;
	...
	public boolean putItemStack(ItemStack item)
	{
		...
		for(ItemStack stack : list)
			if(stack != null && stack.getItem() == item.getItem() && stack.getItemDamage() == item.getItemDamage() && ItemStack.areItemStackTagsEqual(stack, item)
